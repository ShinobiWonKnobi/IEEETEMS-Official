...
export const EVENTS: Event[] = [
    {
        ...
        description: 'An execution-focused student entrepreneurship initiative featuring the "Pitch Roulette" peer-rated pitching session.',
        status: 'upcoming',
    ...
    },
    {
        id: 2,
        date: 'SEP 02-03, 2024',
        title: 'Pitch Perfect 1.0',
        description: 'A dynamic 2-day entrepreneurial summit inspiring students to identify real-world problems and transform ideas into impactful pitches.',
        status: 'past',
        location: 'SRM IST, Kattankulathur',
        time: '10:00 AM - 04:00 PM',
        fullDescription: 'The inaugural edition emphasized practical learning and industry exposure. Features included expert talks, team-based pitch deck creation, and mentorship. It successfully bridged the gap between students and young professionals, fostering a validation-first mindset.'
    }
];
